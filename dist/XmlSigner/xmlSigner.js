        ...
        (function (xmlSigner) {
            var XmlSigner = /** @class */ (function () {
                function XmlSigner(_datacontext, args) {
                    ...
                    this.signerRoot = 'https://localhost:1235';
                    this.method = args.method || 'sha256';
                    this.xades = args.xades || 'bes';
                ...
                XmlSigner.prototype.getSignUrl = function (thumbprint) {
                    ...
                    return this.signerRoot + "/sign?method=" + this.method + thumbprintParam + xadesParam;
                };
                ...
                XmlSigner.prototype.getVersionAsync = function () {
                    var _this = this;
                    return new Promise(function (resolve) {
                        $.ajax({
                            type: 'GET',
                            url: _this.signerRoot + "/getVersion",
                            async: true,
                            success: function (data) {
                                resolve(data === null || data === void 0 ? void 0 : data.Version);
                            },
                ...
                XmlSigner.prototype.isRunningAsync = function () {
