        ...
        (function (keycloakAdapter) {
            var KeycloakAdapter = /** @class */ (function () {
                ...
                KeycloakAdapter.prototype.processHeaders = function (headers) {
                    ...
                    var f = function (resolve, reject) {
                        _this.keycloak.updateToken(30)
                            .then(function () {
                            _this.lastTokenUpdate = new Date();
                            headers.Authorization = "Bearer " + _this.keycloak.token;
                            resolve();
                        }).catch(function (err) {
                            if (console && console.log) {
                                var ago = moment.duration(moment(_this.lastTokenUpdate).diff(moment())).humanize(true);
                                console.log("KeycloakAdapter - Session expired. Last token update " + ago + " at " + _this.lastTokenUpdate + ".");
                            }
                ...
                KeycloakAdapter.prototype.getRolesArr = function () {
                    ...
                    if (!token || !token.resource_access || !this.client) {
                        return undefined;
                    }
                ...
                KeycloakAdapter.prototype.hasSomeRole = function () {
                    var roles = this.getRolesArr();
                    return !!(roles && _.isArray(roles) && roles.length > 0);
                };
    ...
    (function (api) {
        ...
        (function (keycloakAdapter) {
            var KeycloakAdapterApi = /** @class */ (function () {
                ...
                KeycloakAdapterApi.prototype.hasSomeRole = function () {
                    return !!(this.adapter && this.adapter.hasSomeRole());
                };
