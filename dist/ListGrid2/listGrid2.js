...
(function (sffw) {
    ...
    (function (components) {
        ...
        (function (listGrid2) {
            ...
            handlers.listGridfilterDatePicker = handlers.listGridfilterDatePicker || {
                init: function (element, valueAccessor, allBindings, viewModel) {
                    var datePickerWithIcon = allBindings.get('datePickerWithIcon');
                    var displayAtt = allBindings.get('value');
                    var att = valueAccessor();
                    var config = {
                        allowInput: true,
                        enableTime: false
                    };
                    if (datePickerWithIcon) {
                        config.wrap = true;
                    ...
                    var subscription = displayAtt.subscribe(function (newValue) {
                        try {
                            if (_.isNull(newValue)) {
                                att(null);
                            }
                            else if (_.isUndefined(newValue)) {
                                att(undefined);
                            }
                            else if (_.isDate(newValue)) {
                                att(viewModel.localization.currentCulture().strToDate(newValue));
                            }
            ...
            var FilterOptionsWidget = /** @class */ (function () {
                function FilterOptionsWidget(element, isExpandedAtt, viewModel) {
                    ...
                    this.globalClickHandler = function () {
                        if (_this.isOpen()) {
                            _this.closeLB();
                        }
                    };
                    $('html').on('click', this.globalClickHandler);
                    this.globalKeyDownHandler = function (e) {
                        if (e.which === 27 && _this.isOpen()) {
                            _this.closeLB();
                        }
                    };
                    $('html').on('keydown', this.globalKeyDownHandler);
                }
                ...
                FilterOptionsWidget.prototype.dispose = function () {
                    this.$cbox.off('click');
                    this.$cbox.off('keydown');
                    this.$cbox.off('keyup');
                    this.$lbox.off('keydown');
                    this.$lbox.off('keyup');
                    $('li', this.$lbox).off('click');
                    $('li input[type=checkbox]', this.$lbox).off('click');
                    $('html').off('click', this.globalClickHandler);
                    $('html').off('keydown', this.globalKeyDownHandler);
            ...
            handlers.filterOptionsSelect = handlers.filterOptionsSelect || {
                init: function (element, valueAccessor, allBindings, viewModel, bindingContext) {
                    ...
                    ko.utils.domNodeDisposal.addDisposeCallback(element, function () {
                        var widget = $(element).data('ui-filterOptionsWidget');
                        widget.dispose();
        ...
        (function (listGrid2) {
            var ListGridViewModel = /** @class */ (function () {
                function ListGridViewModel(params, componentInfo) {
                    ...
                    this.clearFiltersEnabledBindingValue = ko.pureComputed(function () {
                        var _a, _b;
                        if ((_b = (_a = window.sf.accessibility) === null || _a === void 0 ? void 0 : _a.preferences) === null || _b === void 0 ? void 0 : _b.focusableDisabledButtons) {
                            return true;
                        }
                        else {
                            return _this.isAnyFilterActive();
                        }
                    });
                    this.clearFiltersAriaDisabledBindingValue = ko.pureComputed(function () {
                        var _a, _b;
                        if ((_b = (_a = window.sf.accessibility) === null || _a === void 0 ? void 0 : _a.preferences) === null || _b === void 0 ? void 0 : _b.focusableDisabledButtons) {
                            return !(_this.isAnyFilterActive());
                        }
                    ...
                    this.onPageMinClick = function () {
                        ...
                        if (isEnabled) {
                            ...
                            _this.writeButtonDisabledErrToAriaLiveRegion(_this.dataContext.$localize('ListGrid2$$firstPageAriaLabel'));
                        }
                    };
                    this.onPageMaxClick = function () {
                        ...
                        if (isEnabled) {
                            ...
                            _this.writeButtonDisabledErrToAriaLiveRegion(_this.dataContext.$localize('ListGrid2$$lastPageAriaLabel'));
                        }
                    };
                    this.onPageForwardClick = function () {
                        ...
                        if (isEnabled) {
                            ...
                            _this.writeButtonDisabledErrToAriaLiveRegion(_this.dataContext.$localize('ListGrid2$$nextPageAriaLabel'));
                        }
                    };
                    this.onPageBackClick = function () {
                        ...
                        if (isEnabled) {
                            ...
                            _this.writeButtonDisabledErrToAriaLiveRegion(_this.dataContext.$localize('ListGrid2$$prevPageAriaLabel'));
                        }
                    };
                    ...
                    this.onClearFiltersClick = function () {
                        var _a, _b;
                        var isEnabled = _this.isAnyFilterActive();
                        if (isEnabled) {
                            _this.ctrlCore.clearVisibleFilters();
                            _this.clearViewModelVisibleFilters();
                        }
                        else if ((_b = (_a = window.sf.accessibility) === null || _a === void 0 ? void 0 : _a.preferences) === null || _b === void 0 ? void 0 : _b.focusableDisabledButtons) {
                            _this.writeButtonDisabledErrToAriaLiveRegion(_this.dataContext.$localize('ListGrid2$$clearFilters'));
                        }
                    };
                    ...
                    this.datePickerWithIcon = (_b = (_a = window.sf.accessibility) === null || _a === void 0 ? void 0 : _a.preferences) === null || _b === void 0 ? void 0 : _b.datePickerWithIcon;
                ...
                ListGridViewModel.prototype.onRowsChange = function () {
                    ...
                    var promiseChain = this.dataCollection.$fromJson(this.ctrlCore.rows()).then(function () {
                        ...
                        _this.linkCellClickAndEnterKeyHandlers();
                ...
                ListGridViewModel.prototype.linkCellClickAndEnterKeyHandlers = function () {
                    this.$componentElem.find('.data-row .clickable-grid-cell').on('click touch', function (event) {
                        var td = event.target;
                        var tr = td.parentElement;
                        var $anchor = $(tr).find('th[role=rowheader] > a');
                        $anchor.click();
                    });
                    this.$componentElem.find('.data-row th[role=\'rowheader\'] > a').on('keyup', function (event) {
                        if (event.keyCode === 13) {
                            var a = event.target;
                            var $anchor = $(a);
                            $anchor.click();
                ...
                ListGridViewModel.prototype.setFocusedRow = function (index) {
                    if (index >= 0 && index < this.records().length) {
                        if (ko.unwrap(this.ctrlCore.inlineSearch)) {
                            this.ctrlCore.inlineSearch = ko.observable();
                            this.ctrlCore.focusedRecordIndex = ko.observable();
                        }
                ...
                ListGridViewModel.prototype.writeButtonDisabledErrToAriaLiveRegion = function (btnText) {
                    var msg = this.localization.currentCulture().errorFormatter.formatButtonDisabled(btnText);
                ...
                ListGridViewModel.prototype.ActionButtonClicked = function (button, row, collectionRow) {
                    var _this = this;
                    var _a, _b, _c;
                    var promiseChain = Promise.resolve();
                    var isEnabled = collectionRow ? ko.unwrap((_a = collectionRow[button.IsEnabled]) === null || _a === void 0 ? void 0 : _a.$value) || false : true;
                    if (isEnabled) {
                    ...
                    else if ((_c = (_b = window.sf.accessibility) === null || _b === void 0 ? void 0 : _b.preferences) === null || _c === void 0 ? void 0 : _c.focusableDisabledButtons) {
                        promiseChain = promiseChain.then(function () {
                            var btnText = button.IsTitleTextLocalized === true ? _this.dataContext.$localize(button.TitleText) : button.TitleText;
                            _this.writeButtonDisabledErrToAriaLiveRegion(btnText);
                        });
                    }
                    return promiseChain;
                };
                ...
                ListGridViewModel.prototype.getActionButtonEnabledBindingValue = function (collectionRow, actionButton) {
                    var _a, _b, _c;
                    if ((_b = (_a = window.sf.accessibility) === null || _a === void 0 ? void 0 : _a.preferences) === null || _b === void 0 ? void 0 : _b.focusableDisabledButtons) {
                        return true;
                    }
                    else {
                        return ko.unwrap((_c = collectionRow[actionButton.IsEnabled]) === null || _c === void 0 ? void 0 : _c.$value) || false;
                    }
                };
                ListGridViewModel.prototype.getActionButtonAriaDisabledBindingValue = function (collectionRow, actionButton) {
                    var _a, _b, _c;
                    if ((_b = (_a = window.sf.accessibility) === null || _a === void 0 ? void 0 : _a.preferences) === null || _b === void 0 ? void 0 : _b.focusableDisabledButtons) {
                        return !(ko.unwrap((_c = collectionRow[actionButton.IsEnabled]) === null || _c === void 0 ? void 0 : _c.$value) || false);
                    }
